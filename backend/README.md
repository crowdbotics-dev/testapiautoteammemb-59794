...
## Project Structure
    ...
    ├── testapiautoteammemb_59794  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_59794`
...
2. Clone this repo and `cd testapiautoteammemb_59794`
